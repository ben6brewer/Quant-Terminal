"""Money Supply Toolbar — Home, lookback, M2 stat, settings."""
...
class MoneySupplyToolbar(LazyThemeMixin, QWidget):
    home_clicked = Signal()
    ...
    def _setup_ui(self):
        ...
        self.lookback_combo.setCurrentIndex(3)  # 10Y default
        self.lookback_combo.currentIndexChanged.connect(
            lambda _: self.lookback_changed.emit(self.lookback_combo.currentText())
        )
        ...
        self.view_combo.setCurrentIndex(0)  # Raw default
    ...
    def update_info(self, m2: float = None, date_str: str = ""):
        if m2 is not None:
