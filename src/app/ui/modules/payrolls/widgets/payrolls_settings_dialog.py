...
class PayrollsSettingsDialog(ThemedDialog):
    """Settings dialog for the Payrolls module."""

    def __init__(self, theme_manager, current_settings: dict, parent=None):
        self._current_settings = current_settings
        self.result = None
        super().__init__(theme_manager, "Payrolls Settings", parent, min_width=340)
