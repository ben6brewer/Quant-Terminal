...
from .services.payrolls_settings_manager import PayrollsSettingsManager
...
class PayrollsModule(BaseModule):
    ...
    def _setup_ui(self):
        ...
        self.toolbar = PayrollsToolbar(self.theme_manager)
        layout.addWidget(self.toolbar)

        self.chart = PayrollsChart()
    ...
    def _fetch_data(self):
        self._run_worker(
            ...
            loading_message="Fetching payrolls data from FRED...",
    ...
    def _on_data_fetched(self, result):
        ...
        if result is None:
            self.chart.show_placeholder("Failed to fetch payrolls data.")
            return
    ...
    def _render(self):
        ...
        payrolls = self._slice_monthly(self._data.get("payroll_levels"))
        usrec = self._data.get("usrec")
        self.chart.update_data(payrolls, usrec, settings)
