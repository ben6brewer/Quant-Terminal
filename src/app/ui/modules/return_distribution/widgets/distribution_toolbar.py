"""Distribution Toolbar - Top Control Bar for Return Distribution module."""
...
class DistributionToolbar(ModuleToolbar):
    """Toolbar for Return Distribution module."""
    ...
    custom_date_range_requested = Signal()
    ...
    def setup_center(self, layout: QHBoxLayout):
        ...
        # Window selector (hidden by default)
