"""Natural Gas Toolbar — Home, lookback, view toggle, stats."""
...
class NaturalGasToolbar(FredToolbar):
    """Natural Gas toolbar — view toggle (Raw / YoY %) + latest price."""
    ...
    def update_info(self, natgas=None, **kwargs):
