...
from .services.demographics_settings_manager import DemographicsSettingsManager
...
class DemographicsModule(BaseModule):
    ...
    def _setup_ui(self):
        ...
        self.toolbar = DemographicsToolbar(self.theme_manager)
        layout.addWidget(self.toolbar)

        self.chart = DemographicsChart()
    ...
    def _fetch_data(self):
        self._run_worker(
            ...
            loading_message="Fetching demographics data from FRED...",
    ...
    def _on_data_fetched(self, result):
        ...
        if result is None:
            self.chart.show_placeholder("Failed to fetch demographics data.")
            return
        ...
        if rates_df is not None and not rates_df.empty:
            ...
            self.toolbar.update_info(date_str)
    ...
    def _on_settings_clicked(self):
        ...
        dialog = DemographicsSettingsDialog(
            self.theme_manager,
