"""Demographics Toolbar - Home, lookback, info label, settings."""
...
class DemographicsToolbar(LazyThemeMixin, QWidget):
    """Toolbar with home, lookback, as-of info, and settings."""
    ...
    def update_info(self, date_str: str):
