"""Real Rates Chart — Real interest rates and TIPS yields."""
...
_SERIES_SETTINGS = {
    "5Y TIPS": "show_tips_5y",
    "10Y TIPS": "show_tips_10y",
    "20Y TIPS": "show_tips_20y",
    "30Y TIPS": "show_tips_30y",
}


class RealRatesChart(BaseChart):
    """Real rates TIPS yield curve chart."""
    ...
    def _setup_placeholder(self):
        self._placeholder = QLabel("Loading real rates data...", self)
    ...
    def update_data(self, tips_df: "Optional[pd.DataFrame]",
        ...
        self._render_lines(tips_df, usrec_df, settings)

    def _render_lines(self, df, usrec_df, settings, suffix=""):
        import pandas as pd

        if df is None or df.empty:
            self.show_placeholder("No real rates data available.")
            return
