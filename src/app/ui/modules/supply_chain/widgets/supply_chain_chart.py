"""Supply Chain Chart — Inventory/sales ratios."""
...
_SERIES_COLORS = {
    "Total I/S Ratio": "#4FC3F7",
    "Retail I/S": "#66BB6A",
    "Manufacturing I/S": "#FFA726",
    "Wholesale I/S": "#CE93D8",
}

_SERIES_SETTINGS = {
    "Total I/S Ratio": "show_total_is",
    "Retail I/S": "show_retail_is",
    "Manufacturing I/S": "show_mfg_is",
    "Wholesale I/S": "show_wholesale_is",
}


class SupplyChainChart(BaseChart):
    """Supply chain inventory/sales ratio multi-line chart."""
    ...
    def _setup_placeholder(self):
        self._placeholder = QLabel("Loading inventory data...", self)
    ...
    def update_data(self, inv_df: "Optional[pd.DataFrame]",
        ...
        self._render_lines(inv_df, usrec_df, settings)

    def _render_lines(self, df, usrec_df, settings, suffix=""):
        import pandas as pd

        if df is None or df.empty:
            self.show_placeholder("No inventory data available.")
            return
