"""Labor Market Overview Settings Dialog."""
...
class LaborMarketOverviewSettingsDialog(ThemedDialog):
    """Settings dialog for the Labor Market Overview module."""

    def __init__(self, theme_manager, current_settings: dict, parent=None):
        self._current_settings = current_settings
        self.result = None
        super().__init__(theme_manager, "Labor Market Settings", parent, min_width=380)
    ...
    def _setup_content(self, layout):
        ...
        self.u6_cb = QCheckBox("Show U-6 rate")
        self.u6_cb.setChecked(self._current_settings.get("show_u6", False))
        layout.addWidget(self.u6_cb)
