...
class LaborMarketOverviewToolbar(LazyThemeMixin, QWidget):
    """Toolbar with home button, lookback dropdown, info labels, and settings button."""
    ...
    def _setup_ui(self):
        ...
        self.lookback_combo.setCurrentIndex(2)  # 5Y default
    ...
    def update_info(self, unrate=None):
