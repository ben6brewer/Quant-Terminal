"""Inflation Expectations Toolbar - Home, lookback, info, settings."""
...
class InflationExpectationsToolbar(LazyThemeMixin, QWidget):
    home_clicked = Signal()
    ...
    def update_info(self, breakeven_5y=None):
