"""Government Debt Chart — Dual-mode: Raw debt level or Debt/GDP %."""
...
class GovernmentDebtChart(BaseChart):
    """Government debt chart — single line in both modes."""
    ...
    def _setup_placeholder(self):
        self._placeholder = QLabel("Loading government debt data...", self)
    ...
    def update_data(self, debt_df: "Optional[pd.DataFrame]",
                    debt_gdp_df: "Optional[pd.DataFrame]",
