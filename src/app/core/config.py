...
MODULE_SECTIONS = {
    ...
    "Analysis": [
        ...
        {"id": "factor_models", "label": "Factor Models", "class": "app.ui.modules.factor_models:FactorModelsModule"},
    ...
    "Macro": [
        ...
        {"id": "home_prices", "label": "Home Prices", "class": "app.ui.modules.home_prices:HomePricesModule"},
        {"id": "home_sales", "label": "Home Sales", "class": "app.ui.modules.home_sales:HomeSalesModule"},
        {"id": "housing_supply", "label": "Housing Supply", "class": "app.ui.modules.housing_supply:HousingSupplyModule"},
        {"id": "commercial_real_estate", "label": "Commercial RE", "class": "app.ui.modules.commercial_real_estate:CommercialRealEstateModule"},
        {"id": "wealth_distribution", "label": "Wealth Distribution", "class": "app.ui.modules.wealth_distribution:WealthDistributionModule"},
        {"id": "income_inequality", "label": "Income Inequality", "class": "app.ui.modules.income_inequality:IncomeInequalityModule"},
        {"id": "loan_survey", "label": "Loan Survey (SLOOS)", "class": "app.ui.modules.loan_survey:LoanSurveyModule"},
        {"id": "student_loans", "label": "Student Loans", "class": "app.ui.modules.student_loans:StudentLoansModule"},
        {"id": "population", "label": "Population", "class": "app.ui.modules.population:PopulationModule"},
        {"id": "supply_chain", "label": "Supply Chain", "class": "app.ui.modules.supply_chain:SupplyChainModule"},
