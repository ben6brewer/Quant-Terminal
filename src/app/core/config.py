...
MODULE_SECTIONS = {
    ...
    "Macro": [
        ...
        {"id": "credit_conditions", "label": "Credit & Delinquency", "class": "app.ui.modules.credit_conditions:CreditConditionsModule"},
        {"id": "government_debt", "label": "Government Debt", "class": "app.ui.modules.government_debt:GovernmentDebtModule"},
        {"id": "energy_prices", "label": "Energy Prices", "class": "app.ui.modules.energy_prices:EnergyPricesModule"},
